...
class TemplateOverviewPageController extends PageController
{
    ...
    {
        $listArray = [];
        $listArray['Name'] = $count === 1 ? $obj->i18n_singular_name() : $obj->i18n_plural_name();
        ...
        $listArray['LiveLink'] = $obj->hasMethod('Link') ? $obj->Link(): 'please-add-Link-method';
